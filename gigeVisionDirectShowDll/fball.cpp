...
const AMOVIESETUP_FILTER sudBallax =
{
    ...
    L"GigeVisionSource",       // String name
...
CBouncingBall::CBouncingBall(LPUNKNOWN lpunk, HRESULT *phr) :
    CSource(NAME("GigeVisionSource"), lpunk, CLSID_BouncingBall)
{
    ASSERT(phr);
    ...
    m_paStreams[0] = new CBallStream(phr, this, L"GigeVisionSource");
...
CBallStream::CBallStream(HRESULT *phr,
                         ...
                         LPCWSTR pPinName) :
    CSourceStream(NAME("GigeVisionSource"),phr, pParent, pPinName),
    m_iImageWidth(1024),
    m_iImageHeight(1024),
